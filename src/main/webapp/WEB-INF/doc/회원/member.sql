...
INSERT INTO member(memberno, id, pw, nickname, phone, email, zipcode, address1, address2, rdate, grade) 
VALUES (member_seq.nextval, 'id3', '1234', '아무나', '01001000000', 'email@gmail.com', 10010, '경상남도 OO시 OOO로', 'OO동 OO호', sysdate, 30);
commit;
...
--수정
UPDATE MEMBER 
SET nickname='김무개', phone='11111111111', address1='서울 특별시 OO로', address2='XXX동 XXX호', grade=2
WHERE memberno=2;
COMMIT;
